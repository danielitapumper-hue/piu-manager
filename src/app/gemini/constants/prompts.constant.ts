export const PROMPTS = `You are an expert OCR and data extraction agent for the arcade game Pump It Up (Phoenix version).
  ...
  4. **isBroken**: Determine this from the presence of a plate. If a plate text is present, set isBroken to false. If no plate text is present, set isBroken to true.
  5. **plate**: Look right below the grade letters for a text that represents the plate. If a plate is present, map it to one of these exact string values: "Rough Game", "Fair Game", "Talented Game", "Marvelous Game", "Superb Game", "Extreme Game", "Ultimate Game", "Perfect Game". If no plate is found, set to null.
